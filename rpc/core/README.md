...
The user can subscribe to events emitted by PellDVS, using `/subscribe`. If
...
("client is not pulling messages fast enough"). If PellDVS exits, all
subscriptions are canceled ("PellDVS exited"). The user can unsubscribe
