...
func TestNodeInfoValidate(t *testing.T) {
	...
	testCases := []struct {
		...
		{"Non-ASCII DvsRequestIndex", func(ni *DefaultNodeInfo) { ni.Other.DvsRequestIndex = nonASCII }, true},
		{"Empty tab DvsRequestIndex", func(ni *DefaultNodeInfo) { ni.Other.DvsRequestIndex = emptyTab }, true},
		{"Empty space DvsRequestIndex", func(ni *DefaultNodeInfo) { ni.Other.DvsRequestIndex = emptySpace }, true},
		{"Empty DvsRequestIndex", func(ni *DefaultNodeInfo) { ni.Other.DvsRequestIndex = "" }, false},
		{"Off DvsRequestIndex", func(ni *DefaultNodeInfo) { ni.Other.DvsRequestIndex = "off" }, false},
