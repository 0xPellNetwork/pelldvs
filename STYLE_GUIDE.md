...
* Product names are capitalized, like "PellDVS", "Basecoin", "Protobuf", etc except in command lines: `pelldvs --help`
...
* When importing a pkg from the `cmt/libs` directory, prefix the pkg alias with cmt.
    * cmtbits "github.com/0xPellNetwork/pelldvs/libs/bits"
...
* Every repo should have a version/version.go file that mimics the PellDVS repo
